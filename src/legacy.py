...
def load_network_pkl(f, force_fp16=False, strict=True):
...
class _LegacyUnpickler(pickle.Unpickler):
    def find_class(self, module, name):
        ...
        if name in ["EdgeBlock", "AdaptivePointNorm", "SPGANGenerator", "DGCNN"]:
            module = "src.training.networks_spgan"
        elif name in ["DPSR"]:
            module = "src.training.networks_dpsr"
